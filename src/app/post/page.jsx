...
const AddClient = () => {
  ...
  const onSubmit = async(data) => {
    // amount-কে নাম্বার টাইপে কনভার্ট করা হয়েছে
    const formattedData = {
      ...data,
      sl: Number(data.sl),
    ...
    // console.log('Inserted Client Data:', formattedData);
  ...
  return (
    <div className="max-w-3xl mx-auto p-4 md:p-6 bg-white rounded-xl shadow-md border border-gray-100 my-6">
      ...
      <div className="mb-6 border-b border-gray-100 pb-4">
        ...
        <Link href={'/'} className='btn btn-info text-white' >Back</Link>
      </div>

      {/* Main Form */}
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        {/* Responsive Grid Layout (মোবাইলে ১ কলাম, বড় স্ক্রিনে ২ কলাম) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="form-control w-full">
            ...
            <input
              ...
              {...register('ip', {
                required: 'IP Address/Username is required',
              })}
            />
            {errors.ip && (
              <span className="text-xs text-red-500 mt-1">
          ...
          <div className="form-control w-full">
            ...
            <input
              ...
              {...register('connection_date', {
                required: 'Connection date is required',
              })}
            />
            {errors.connection_date && (
              <span className="text-xs text-red-500 mt-1">
                {errors.connection_date.message}
              </span>
            )}
          </div>
        </div>
